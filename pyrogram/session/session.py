...
from pyrogram.errors import RPCError, InternalServerError, AuthKeyDuplicated, FloodWait, ServiceUnavailable, UnknownError
...
class Session:
    ...
    async def send(
        ...
        while True:
            ...
            except (OSError, TimeoutError, InternalServerError, ServiceUnavailable, UnknownError) as e:
                if retries == 0:
                    raise e from None
